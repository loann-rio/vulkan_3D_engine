...
void ColorPass::createRenderPass(VkFormat imageFormat, VkFormat depthFormat)
{
    ...
    colorAttachment.finalLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;// VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; // VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL
    ...
    renderPassInfo.pDependencies = dependencies;// &dependency;

...
//namespace std {
//	template<>
//	struct hash<ObjModel::Vertex>
//	{
//		size_t operator()(ObjModel::Vertex const& vertex) const {
//			size_t seed = 0;
...
//}
//
//ObjModel::ObjModel(Device& device, const ObjModel::Builder& builder, const char* filePathTexture) : device{ device } {
...
//ObjModel::~ObjModel() {}
//
//std::unique_ptr<ObjModel> ObjModel::createModelFromFile(Device& device, const std::string& filePath, const char* filePathTexture)
//{
//	Builder builder{};
//	builder.loadModel(filePath);
//	std::cout << "vertex count: " << builder.vertices.size() << "\n";
//	return std::make_unique<ObjModel>(device, builder, filePathTexture);
//}
//
...
//}
//
//void ObjModel::draw(VkCommandBuffer commandBuffer)
//{
//	if (hasIndexBuffer) {
...
//}
//
////VkDescriptorImageInfo ObjModel::getImageInfo()
////{
